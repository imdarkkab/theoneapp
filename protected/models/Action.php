...
class Action extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('action_code, action_name', 'required'),
			array('action_code', 'length', 'max'=>20),
			array('action_name', 'length', 'max'=>256),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('action_id, action_code, action_name', 'safe', 'on'=>'search'),
		);
	}
